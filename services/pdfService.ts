...
function addThaiFontToJsPDF(doc: jsPDF) {
  ...
  doc.addFileToVFS("Kanit-Regular.ttf", "AAEAAAASAQAABAAgR0RFRgA..."); // (base64 encoded font file - too large for example, actual base64 data would go here)
  ...
  let htmlContent = `
    ...
    <div style="font-family: 'Kanit', sans-serif;">
      ...
      <div style="margin-bottom: 15px; font-size: 14px;">
        ...
        <p><strong>เวลาเฉลี่ยต่อข้อ:</strong> ${(sessionData.totalTime / 1000 / sessionData.answers.length).toFixed(2)} วินาที</p>
      </div>
